...
class PersonInfo(models.Model):
    ...
    carid = models.CharField(default="", max_length=30, verbose_name="车牌号", help_text="车牌号")
    ...
    travel_mode = models.IntegerField(choices=TRAVEL_TYPE, verbose_name="春运出行方式", help_text="春运出行方式")
    springtime = models.DateTimeField(default="", verbose_name="春运日期")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
    desc = models.TextField(default="", verbose_name="备注情况", help_text="备注情况")
